...
export default function Reservists() {
  ...
  const fetchReservists = useCallback(async () => {
    ...
    try {
      const params = {
        ...
        arsen_id: selectedArsen || undefined,
  ...
  }, [page, limit, search, selectedArsen, selectedGroup, selectedCity, statusFilter]);
  ...
  const handleDelete = async (id) => {
    if (!confirm('Are you sure you want to delete this reservist?')) return;
    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        alert(data.message || 'Failed to delete reservist');
      }
    } catch {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
            Manage reservist records, assignments, and status
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 p-4 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search by name, ID number, or service number..."
            value={search}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
          ...
          >
            ...
            {(Array.isArray(arsens) ? arsens : []).map(a => (
                      ...
                      <tr key={reservist.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <span className={cn(
                            ...
                            {reservist.is_active ? 'Active' : 'Inactive'}
                          </span>
                        </td>
